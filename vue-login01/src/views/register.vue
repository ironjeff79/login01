  ...
  <div class="layout">
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" style="max-width: 400px">
      <el-form-item label="ユーザー名" prop="userId">
        ...
        <el-input style="display: inline;width:280px" type="username" v-model="ruleForm.userId"
          autocomplete="ユーザー名は5桁から10桁の間に入力してください"></el-input>
      </el-form-item>
      <el-form-item label="メール" prop="mail">
        <span style="color:red;display: inline;">*</span>
        <el-input style="display: inline;width:280px" type="mail" v-model="ruleForm.mail" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="携帯電話" prop="phoneNum">
        <span style="color:red;display: inline;">*</span>
        <el-input style="display: inline;width:280px" type="phoneNum" v-model="ruleForm.phoneNum"
          autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="パスワード" prop="pass">
        <span style="color:red;display: inline;">*</span>
        <el-input style="display: inline;width:280px" type="password" v-model="ruleForm.pass"
          autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="再入力" prop="checkPass">
        <span style="color:red;display: inline;">*</span>
        <el-input style="display: inline;width:280px" type="password" v-model="ruleForm.checkPass"
          autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    validForm() {
      ...
      if (!this.ruleForm.phoneNum) {
        ElMessage.warning('携帯番号を入力してください！');
        return false;
      }
